...
class WhittleMainWindow(QMainWindow):
    ...
    def append_markdown_message(self, prefix: str, content: str, is_error: bool = False):
        ...
        if is_error:
            ...
            try:
                ...
                html_content = f'<p>{prefix}: {content}</p>'
    ...
    def send_message(self):
        ...
        if message:
            ...
            try:
                ...
                self.append_markdown_message("Assistant", response)
            except Exception as e:
                self.append_markdown_message("Error", str(e), is_error=True)
