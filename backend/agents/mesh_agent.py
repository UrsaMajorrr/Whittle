...
class MeshAgent:
    """Mesh Agent for handling mesh generation and optimization tasks"""
    
    def __init__(self, config: dict):
        """Initialize the Mesh agent with configuration"""
        self.config = config
    ...
    def _create_agent(self):
        ...
        config = {
            ...
            "description": "Mesh Assistant that always responds with role 'assistant'",
        }
    ...
    def _generate_response_sync(self, messages):
        ...
        try:
            ...
            print(f"Detailed error in Mesh agent: {str(e)}")
            import traceback
    ...
    async def chat(self, message: str, history: List[Message]) -> str:
        ...
        try:
            ...
            print(f"Error in Mesh agent chat: {str(e)}")
            return f"I encountered an error while processing your request: {str(e)}"
    
    async def generate_mesh(self, geometry: Dict[str, Any], params: Dict[str, Any]) -> Dict[str, Any]:
        """Generate mesh from geometry with given parameters"""
    ...
    async def optimize_mesh(self, mesh_data: Dict[str, Any], criteria: Dict[str, Any]) -> Dict[str, Any]:
        """Optimize mesh based on given criteria"""
    ...
    async def validate_mesh(self, mesh_data: Dict[str, Any]) -> Dict[str, Any]:
